...
error of 6.1 percent on a saved measurement corpus, which is strong for pre-launch
screening when users keep 10\% headroom.
\end{abstract}

\input{sections/01_intro}
\input{sections/02_resident_activation}
\input{sections/04_strategy_workflow}
\input{sections/05_measurement_evaluation}
\input{generated/accuracy_summary}
\input{sections/06_limitations_related_work}
